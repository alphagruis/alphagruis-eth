<p align="center">
  <img width="128" height="128" src="alphagruis-eth.svg">
  <img width="128" height="128" src="alphagruis-eth-logo.svg">
</p>

# :small_orange_diamond: alphagruis's Miner for Ethereum

**alphagruis**'s Miner for **Ethereum**, is a high performance and rock solid miner. This miner was designed and implemented in C++, OpenCL and CUDA **from scratch** by the **alphagruis** team, a small group of skilled developers. Official binaries are currently only available for the **Windows** platform.
...
ex. alphagruis-eth.json file in JSON format to mine with the *ethermine* pool:
